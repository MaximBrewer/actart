                            ...
                            <div class="panel-body no-padding-left-right">
                                <div class="col-md-10 no-padding-left-right">
                                    ...
                                    @elseif($setting->type == "checkbox")
                                        ...
                                        @endif
                                    @elseif($setting->type == "table")
                                        <?php $value = json_decode($setting->value, true); ?>
                                        <table>
                                            @for($i=0;$i<9;$i++)
                                            <tr>
                                                <td>от&nbsp;</td>
                                                <td><input type="text" class="form-control" name="{{ $setting->key }}[{{$i}}][from]" value="{{ $value[$i]['from'] }}"></td>
                                                <td>&nbsp;до&nbsp;</td>
                                                <td><input type="text" class="form-control" name="{{ $setting->key }}[{{$i}}][to]" value="{{ $value[$i]['to'] }}"></td>
                                                <td>&nbsp;шаг&nbsp;</td>
                                                <td><input type="text" class="form-control" name="{{ $setting->key }}[{{$i}}][step]" value="{{ $value[$i]['step'] }}"></td>
                                            </tr>
                                            @endfor
                                        </table>
                                    @endif
