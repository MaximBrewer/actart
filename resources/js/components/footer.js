                    ...
                    <div className="row">
                        ...
                        <div className="col-md-20 align-items-center align-items-md-start">
                            <div className="d-xl-flex">
                                <div className="pb-2">{__('Сайт сделан в  ВАША КОМПАНИЯ')}</div>
                                <div className="d-md-flex">
                                    <div className="pb-2">{__('Разработка')}</div>
                                    <div className="pb-2"><Cp /></div>
                                </div>
                            </div>
                        </div>
                    </div>
